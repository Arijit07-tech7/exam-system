...
if (student) {
    ...
    try {
        ...
        if (student.attempt === true) {
            alert("You have already completed your exam!");
            return;
        }
        ...
        document.getElementById("studentSet").innerText = "Question Set : " + student.set;
        document.getElementById("examStudent").innerText = student.name;
